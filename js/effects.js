/* ============================================================
   EFFECTS — GSAP Orchestration & Premium Interactions
   ============================================================ */
(function () {
  'use strict';
  ...
  // ============================================================
  // 2. GSAP SCROLL REVEAL — replaces fadeObserver
  // ============================================================
  ...
  if (reducedMotion) {
    ...
    // Animated counter for highlight numbers
  ...
  // ============================================================
  // 3. HERO ENTRANCE — Staggered Timeline
  // ============================================================
  if (!reducedMotion) {
    var heroEls = {
  ...
  if (!isTouch && !reducedMotion) {
    ...
    if (dot && circle) {
      ...
      // Trailing circle with GSAP ticker
  ...
  // ============================================================
  // 7. SECTION PARALLAX (Desktop only)
  // ============================================================
